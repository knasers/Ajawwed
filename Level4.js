...
var mountain4 = 'assets/imagesnew/5-mountain-parallax.png';
var buildinglevel4 = 'Asset/images/building4.png';
...
var block4 = 'Asset/images/block0008.png';
var cloud4 = 'Asset/images/cloudslevel4.png';
var movingBlocksImg4 = 'Asset/images/block0009.png';// صورة الكتلة المتحركة المضافة
...
var treasure4 = 'Asset/images/wins0004.png';
...
var Level4 = new Phaser.Class({
    ...
    init: function (data) {
        this.levelConfig = {
            file: (data && data.levelFile) || 'data/level4.json',
            name: (data && data.levelName) || 'المستوى الرابع : التسامح'
        };
    ...
    preload: function () {
        ...
        // Load the correct JSON file for Level 4
        this.load.json('questionsData', this.levelConfig.file);

        this.load.image('arrow', arrow);
        this.load.image('bglevel', bglevel);
        this.load.image('mountain4', mountain4);
        this.load.image('buildinglevel4', buildinglevel4);
        ...
        this.load.image('block4', block4);
        this.load.image('movingBlocks4', movingBlocksImg4); // تحميل صورة الكتلة المتحركة
        this.load.image('cloud4', cloud4);
        this.load.image('treasure4', treasure4);
    ...
    bgsound.play({ loop: true });
        ...
        cloud4 = this.add.image(640, 350, 'cloud4');

        this.add.image(1100, 390, 'mountain4').setScale(0.5);
        this.add.image(3350, 400, 'mountain4').setScale(0.5);
        this.add.image(5600, 390, 'mountain4').setScale(0.5);

        this.add.image(630, 310, 'buildinglevel4').setScale(1);
        this.add.image(630*3, 310, 'buildinglevel4').setScale(1);
        this.add.image(630*5, 310, 'buildinglevel4').setScale(1);
        ...
        // إضافة الكتل الثابتة
        this.add.image(350, 500, 'block4').setScale(0.7);
        this.add.image(700, 300, 'block4').setScale(0.7);
        this.add.image(1100, 500, 'block4').setScale(0.7);
        this.add.image(1700, 350, 'block4').setScale(0.7);
        this.add.image(2100, 150, 'block4').setScale(0.7);
        this.add.image(2400, 350, 'block4').setScale(0.7);
        this.add.image(2800, 500, 'block4').setScale(0.7);
        this.add.image(3225, 300, 'block4').setScale(0.7);
        this.add.image(3700, 500, 'block4').setScale(0.7);

        // إضافة 4 كتل متحركة (2 أفقي و 2 رأسي)
        movingBlocks1 = this.physics.add.sprite(800, 200, 'movingBlocks4').setScale(0.7); // أفقية
        movingBlocks2 = this.physics.add.sprite(1800, 400, 'movingBlocks4').setScale(0.7); // أفقية
        movingBlocks3 = this.physics.add.sprite(2500, 100, 'movingBlocks4').setScale(0.7); // رأسية
        movingBlocks4 = this.physics.add.sprite(3300, 300, 'movingBlocks4').setScale(0.7); // رأسية
        
        // حركة الكتل الأفقية
        this.tweens.add({
            targets: movingBlocks1,
            x: 1300,
            duration: 4000,
            yoyo: true,
            repeat: -1
        ...
        Tre4 = this.physics.add.image(3200, 20, 'treasure4').setScale(1);
        Tre4.setVisible(false);
                
        Tre4.body.setEnable(false);
        ...
        this.physics.add.collider(movingBlocks1, platforms);
        this.physics.add.collider(movingBlocks2, platforms);
        this.physics.add.collider(movingBlocks3, platforms);
        this.physics.add.collider(movingBlocks4, platforms);
        ...
        this.physics.add.collider(Tre4, platforms);
        ...
        this.physics.add.collider(charOne, movingBlocks1);
        this.physics.add.collider(charOne, movingBlocks2);
        this.physics.add.collider(charOne, movingBlocks3);
        this.physics.add.collider(charOne, movingBlocks4);

        this.physics.add.overlap(charOne, Tre4, TreHit4, null, this);

        function TreHit4(charOne, TreHit) {
            this.time.addEvent({
                delay: 1000,
                callback: () => {
        ...
        this.physics.add.overlap(charOne, coins, collectCoin4, null, this);
        ...
        scoreText.setScrollFactor(0, 0);
        function collectCoin4(charOne, coin) {
 ...
 if (score4 >= 5 && score4 < 10) {
            ...
            if (hitMoneys >= 5) {  // تغيير من score4 >= 25 إلى hitMoneys >= 5
                Tre4.setVisible(true);
                Tre4.body.setEnable(true);
